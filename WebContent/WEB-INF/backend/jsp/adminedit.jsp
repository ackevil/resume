				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" id="username" value="${user.adminuserName} " />
							</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-4">
								<input type="text" class="form-control" id="password" value="${user.adminuserPwd}" />
							</div>
						</div>
						<div class="form-group">
							
							<div class="col-xs-2 col-xs-offset-5">
								<button id="updateUser" class="form-control btn btn-primary">确定</button>
							</div>
						</div>
						</div>
